...
public class LectureRoomTimetableController {
    ...
    public Header<List<LectureRoomTimetableDto>> lectureRoomList(
            @PageableDefault(sort = {"lectureRoomTimetableIdx"}) Pageable pageable,
            SearchRoom searchRoom
    ) {
        return lectureRoomTimetableService.getLectureRoomList(pageable, searchRoom);
    }
}
